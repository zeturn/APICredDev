    ...
    <div className="space-y-6">
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={8}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Card className="p-6 transparent-card" style={{ backgroundColor: "transparent", background: "transparent", boxShadow: "none", border: "none" }}>
        ...
        <Grid item xs={12} md={4}>
          <Card className="h-full p-6 transparent-card" style={{ backgroundColor: "transparent", background: "transparent", boxShadow: "none", border: "none" }}>
                <div className="mb-2 flex items-center justify-between">
                  <Typography variant="body2" color="textSecondary">
